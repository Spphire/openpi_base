...
import openpi.policies.single_iphone_vr_flexiv_policy as single_iphone_vr_flexiv_policy
...
@dataclasses.dataclass(frozen=True)
class LeRobotAsyncBiFlexivDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig, *args, **kwargs) -> DataConfig:
        ...
        data_transforms = _transforms.Group(
            inputs=[async_biflexiv_policy.AsyncBiFlexivInputs(model_type=model_config.model_type)],
            outputs=[async_biflexiv_policy.AsyncBiFlexivOutputs()],
        )
        model_transforms = ModelTransformFactory()(model_config)
        if self.extra_delta_transform:
            delta_action_mask = _transforms.make_bool_mask(6, -1, 6, -1)
            data_transforms = data_transforms.push(
                inputs=[_transforms.UmiZeroStateAndRealRelativeActions(delta_action_mask)], # Use UmiZeroStateAndRealRelativeActions to convert state and actions to zero state and real relative actions space
...
@dataclasses.dataclass(frozen=True)
class LeRobotBimanualFlexivV3DataConfig(DataConfigFactory):
...
@dataclasses.dataclass(frozen=True)
class LeRobotBimanualiPhoneFlexivDataConfig(DataConfigFactory):
...
@dataclasses.dataclass(frozen=True)
class LeRobotSingleiPhoneFlexivVRDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig, *args, **kwargs) -> DataConfig:
        ...
        data_transforms = _transforms.Group(
            inputs=[single_iphone_vr_flexiv_policy.SingleiPhoneVRFlexivInputs(model_type=model_config.model_type)],
            outputs=[single_iphone_vr_flexiv_policy.SingleiPhoneVRFlexivOutputs()],
        )
        model_transforms = ModelTransformFactory()(model_config)
        if self.extra_delta_transform:
            data_transforms = data_transforms.push(
...
_CONFIGS = [
    TrainConfig(
        name="pi05_iPhoneSingle_pv2_100_30", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=30, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/pv2_100", # change dataset name here
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_hardtowel_660_30fps", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=30, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/hardtowel_660", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_hardtowel_660_3down", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/hardtowel_660_3down", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_hardtowel_660", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/hardtowel_660", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_blocks_300", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/blocks_300", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_blocks_200", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/blocks_200", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_blocks_100", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/blocks_100", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_pourmsg_300", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/pourmsg_300", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_pourmsg_200", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/pourmsg_200", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_pourmsg_100", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/pourmsg_100", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_pour_msg", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotBimanualiPhoneFlexivDataConfig(
            repo_id="flexiv/shop_bagging", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_iPhoneBimanual_foldtowel", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotBimanualiPhoneFlexivDataConfig(
            repo_id="flexiv/foldtowel_bimanual", # change dataset name here
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_iPhoneBimanual_debug", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotBimanualiPhoneFlexivDataConfig(
            repo_id="flexiv/debug_bimanual", # change dataset name here
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_foldtowel", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/foldtowel", # change dataset name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_tableware2.0", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/tableware2.0", # change dataset name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_tableware", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/tableware", # change dataset name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_iPhoneSingle_debug", # change config name here
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False), # change chunk size here
        data=LeRobotSingleiPhoneFlexivDataConfig(
            repo_id="flexiv/debug_single", # change dataset name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_lego_testnedf_1208",
        ...
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/test_nedf_1208", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_lego_1128",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_lego_1128", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_tubes_1128",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_tubes_1128", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_tubes_1127",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_tubes_1127", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_tubes_1126",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_tubes_1126", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_tubes_1125",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_tubes_1125", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_tubes_1124",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_tubes_1124", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_sort_tubes_1122",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/sort_tubes_1121", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_pick_merged_test_1117",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/merged_060811_1", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_pick_merged_test",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/merged_test", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_pick_merge_1113",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/pick_tubes_merge_1113_1", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_pick_merge_1112",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/pick_tubes_merge_1112", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi05_place1107_debug",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/pick_tubes_1106", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/pick_tubes_1105", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/pick_two_tubes_1104", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/pick_1103_debug", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=100, discrete_state_input=False, async_action_horizon=1),
        data=LeRobotAsyncBiFlexivDataConfig(
            repo_id="flexiv/cubes1102", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi0_place1021",
        model=pi0_config.Pi0Config(pi05=False, action_horizon=40, discrete_state_input=False),
        data=LeRobotBimanualFlexivV3DataConfig(
            repo_id="flexiv/place_1021", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        ...
        data=LeRobotBimanualFlexivDataConfig(
            repo_id="flexiv/pick_1015merged", # change name here
            base_config=DataConfig(prompt_from_task=False),
            extra_delta_transform=True,
        ),
        batch_size=64,
