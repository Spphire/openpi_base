...
def make_bimanual_iphone_vr_flexiv_example() -> dict:
    ...
    return {
        ...
        "observation/left_eye_image": np.random.randint(256, size=(224, 224, 3), dtype=np.uint8),
...
class BimanualiPhoneVRFlexivInputs(transforms.DataTransformFn):
    """
...
@dataclasses.dataclass(frozen=True)
class BimanualiPhoneVRFlexivOutputs(transforms.DataTransformFn):
    """
